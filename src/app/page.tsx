    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 font-medium py-3 px-6 rounded-xl shadow-sm hover:shadow-md hover:border-gray-400 transition-all"
        >
        ...
        <p className="text-xs text-gray-400 mt-4">登入後可同步 Google Calendar，完全免費</p>
      </div>
    </div>
  )
}
